...
function handleViewRequest(req, res) { 
	...
	res.send(`<html><head></head><body><div style="width: 49.5% !important; height:100%;"> <iframe id="left" style="width: 100%; height: 100%;" src="https://www.google.com/search?q=%${req.cookies.urls.articleURL}&btnI=Im+Feeling+Lucky"></iframe></div> <div style="width: 49.5% !important;"><iframe id="right" style="width: 100%; height: 100%;" src="https://www.google.com/search?q=%${req.cookies.urls.newURL}&btnI=Im+Feeling+Lucky"></iframe></div></body></html>`);
}
